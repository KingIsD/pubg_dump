...
enum class EViewModeIndex : uint8_t
{
	...
	VMI_PBRValidation_BaseColor    = 24,
	VMI_PBRValidation_BaseColor_NoMetallic = 25,
	VMI_PBRValidation_MaterialAO   = 26,
	VMI_PBRValidation_Metallic     = 27,
	VMI_PBRValidation_Roughness    = 28,
	VMI_PBRValidation_Specular     = 29,
	VMI_Max                        = 30,
	VMI_Unknown                    = 31
};
...
// Enum Engine.EScopeMaskType
enum class EScopeMaskType : uint8_t
{
	SMT_Near                       = 0,
	SMT_Far                        = 1,
	SMT_Both                       = 2,
...
// Enum TslGame.EInteractionAdditionalMessageType
enum class EInteractionAdditionalMessageType : uint8_t
{
	IAMT_NONE                      = 0,
	IAMT_AVAILABLE                 = 1,
	IAMT_UNAVAILABLE               = 2,
...
// Enum TslGame.ECooperationRequest
enum class ECooperationRequest : uint8_t
{
	CR_NONE                        = 0,
	CR_BodyCarry_Pickup            = 1,
	CR_BodyCarry_Drop              = 2,
	CR_MAX_VALUE                   = 3,
	CR_MAX                         = 4
};
...
enum class EInteractionPlatformType : uint8_t
{
	...
	Console_BHold                  = 4,
	Console_Custom                 = 5,
	Console_XDoubleTap             = 6,
	Console_BDoubleTap             = 7,
	EInteractionPlatformType_MAX   = 8
};
...
// Enum TslGame.ETslBombGameSwitchTeamType
enum class ETslBombGameSwitchTeamType : uint8_t
{
	DoNot                          = 0,
	PingPong                       = 1,
	Blance                         = 2,
	HalfRounds                     = 3,
	ETslBombGameSwitchTeamType_MAX = 4
};
...
// Enum TslGame.EMonsterAction
enum class EMonsterAction : uint8_t
{
	EA_None                        = 0,
	EA_RestTo4LegStand             = 1,
	EA_2LegTo4Stand                = 2,
	EA_4LegTo2Stand                = 3,
	EA_MAX                         = 4
};
...
// Enum TslGame.EMonsterStance
enum class EMonsterStance : uint8_t
{
	eStance_None                   = 0,
	eStance_Stand                  = 1,
	eStance_Sneak                  = 2,
...
// Enum TslGame.EBlizzardZoneState
enum class EBlizzardZoneState : uint8_t
{
	BlizzardDisabled               = 0,
	BeforeMatch                    = 1,
	WaitingStartDelay              = 2,
	BlizzardWarning                = 3,
	ActivateEffectPlaying          = 4,
	StormActivated                 = 5,
	StormDeactivated               = 6,
	StormActorRemoved              = 7,
	BlizzardFinished               = 8,
	EBlizzardZoneState_MAX         = 9
};
...
// Enum TslGame.ETslHASFixAnimPhase
enum class ETslHASFixAnimPhase : uint8_t
{
	PhaseNone                      = 0,
	PhaseFixing                    = 1,
	PhaseBroken                    = 2,
...
// Enum TslGame.EHASSeekerCostumeType
enum class EHASSeekerCostumeType : uint8_t
{
	DeathSlinger                   = 0,
	EHASSeekerCostumeType_MAX      = 1
};
...
// Enum TslGame.ETslHASBuffType
enum class ETslHASBuffType : uint8_t
{
	KillerBasicSpeed               = 0,
	KillerInvincibility            = 1,
	KillerDamagedSpeed             = 2,
	KillerRestriction              = 3,
	SurvivorBasicSpeed             = 4,
	SurvivorDamagedSpeed           = 5,
	SurvivorRestriction            = 6,
	SurvivorEndGameDead            = 7,
	ETslHASBuffType_MAX            = 8
};
...
// Enum TslGame.ETslHASPrisonAnimPhase
enum class ETslHASPrisonAnimPhase : uint8_t
{
	PhaseNone                      = 0,
	PhaseBroken                    = 1,
	PhaseHooked                    = 2,
	PhaseSacrificed                = 3,
	PhaseReload                    = 4,
	ETslHASPrisonAnimPhase_MAX     = 5
};


// Enum TslGame.ETslHASPalletActorAnimPhase
enum class ETslHASPalletActorAnimPhase : uint8_t
{
	PhaseNone                      = 0,
	PhaseSlap                      = 1,
	PhaseBroken                    = 2,
	ETslHASPalletActorAnimPhase_MAX = 3
};
...
// Enum TslGame.EShuttleHeadingDir
enum class EShuttleHeadingDir : uint8_t
{
	XPositive                      = 0,
	XNegative                      = 1,
	YPositive                      = 2,
	YNegative                      = 3,
	EShuttleHeadingDir_MAX         = 4
};
...
enum class EChromaSDKSceneMode : uint8_t
{
	SM_Replace                     = 0,
	SM_Max                         = 1,
	SM_Min                         = 2,
...
enum class EChromaSDKSceneBlend : uint8_t
{
	SB_None                        = 0,
	SB_Invert                      = 1,
	SB_Threshold                   = 2,
